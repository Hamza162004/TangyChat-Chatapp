          ...
          {addMembers &&
            (isGroupMember ? (
              ...
              <button
                onClick={() => handler(_id)}
                type="button"
                className="flex justify-between px-1 text-sm items-center text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full   py-1 me-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
