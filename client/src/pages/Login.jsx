                            ...
                            {isLogin ? (
                                ...
                                (<>
                                    ...
                                    <div className='flex flex-col w-fit relative m-auto items-center' >
                                        <Avatar  sx={{ width: "6rem", margin: "5px", height: "6rem", objectFit: 'cover' }} src={avatar.preview?avatar.preview:"https://api.dicebear.com/7.x/adventurer-neutral/svg?seed=mail@ashallendesign.co.uk"}>

                                        </Avatar >
                                        <IconButton sx={{ position: 'absolute', right: "0px", bottom: "0px", color: "white", bgcolor: "rgba(0,0,0,0.5)", padding: "4px", " :hover": { bgcolor: "rgba(0,0,0,0.7)" } }} component="label">
                                            ...
                                            <input onChange={avatar.changeHandler} type="file" name="userImage" id="userImage" style={{ clip: "rect(0 0 0 0)" }} className='absolute border-[0px] overflow-hidden whitespace-nowrap w-1 h-1 p-[0px]' />
                                        </IconButton>
                                        
                                    </div>
                                    {
                                            avatar.error && (
                                                <Typography  margin={'1rem'} display={'block'} textAlign={'center'} color="error" variant='caption' >
                                                    {avatar.error}
                                                </Typography>
                                            )
                                        }
                                    <form className="space-y-4 md:space-y-4 pt-6" action="#" onSubmit={handleSignUP}>
                                        <TextField
                                            id="outlined"
                                            name='username'
                                            label="Username"
